...
let VendGorjeta = 0
for (item of receita) {
  VenTotal = VenTotal + item.valor
  VendGorjeta = VendGorjeta + item.gorjeta + item.valor
}
console.log('Total de vendas + gorgetas: R$', VendGorjeta)
console.log('Total de vendas: R$', VenTotal)
